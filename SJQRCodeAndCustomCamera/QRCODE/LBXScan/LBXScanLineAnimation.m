...
- (void)stepAnimation
{
    ...
    CGFloat leftx = _animationRect.origin.x + 3;
    CGFloat width = _animationRect.size.width - 6;
    
    self.frame = CGRectMake(leftx, _animationRect.origin.y + 8, width, 1.5);
...
//        CGFloat width = _animationRect.size.width - 6;
        ...
        self.frame = CGRectMake(leftx, _animationRect.origin.y + _animationRect.size.height - 8, width, 1.5);
...
- (void)startAnimatingWithRect:(CGRect)animationRect InView:(UIView *)parentView Image:(UIImage*)image
{
    ...
    CGFloat leftx = animationRect.origin.x + 3;
    CGFloat width = animationRect.size.width - 6;
    
    self.frame = CGRectMake(leftx, centery+2*num, width, 1.5);
    self.image = image;
